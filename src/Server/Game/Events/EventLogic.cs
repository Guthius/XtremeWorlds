                                ...
                                if (!restartlist && !endprocess)
                                {
                                    ...
                                    switch (command.Index)
                                    {
                                        case (byte) EventCommand.AddText:
                                        {
                                            ...
                                            {
                                                case 0: // Player
                                                    Network.PlayerMessage(i, command.Text1, command.Data1);
                                                    break;
                                                case 1: // Map
                                                    Network.MapMessage(map, command.Text1);
                                                    break;
                                                case 2: // Global
                                                    Network.GlobalMessage(command.Text1);
                                                    break;
                                            }
                                        ...
                                        case (byte) EventCommand.RestoreHealth:
                                            SetVital(i, Core.Globals.Vital.Health, Script.Instance?.GetMaxHP(i, Core.Globals.Vital.Health));
                                            Network.Vital(i, Core.Globals.Vital.Health);
                                            break;

                                        case (byte) EventCommand.RestoreMana:
                                            SetVital(i, Core.Globals.Vital.Mana, Script.Instance?.GetMaxMP(i, Core.Globals.Vital.Mana));
                                            Network.Vital(i, Core.Globals.Vital.Mana);
                                            break;

                                        case (byte) EventCommand.RestoreStamina:
                                            SetVital(i, Core.Globals.Vital.Stamina, Script.Instance?.GetMaxSP(i, Core.Globals.Vital.Stamina));
                                            Network.Vital(i, Core.Globals.Vital.Stamina);
                                            break;
                                        ...
                                        case (byte) EventCommand.PlayAnimation:
                                        {
                                            ...
                                            {
                                                case 0: // On Player
                                                    Network.PlayAnimation(map, command.Data1, GetX(i), GetY(i), (byte) TargetType.Player, i);
                                                    break;
                                                case 1: // On Event
                                                {
                                                    ...
                                                    if (Server.Map.Instance[map].Event[command.Data3].Globals == 1)
                                                    {
                                                        ...
                                                        Network.PlayAnimation(map, command.Data1,
                                                ...
                                                case 2: // On Coordinates
                                                    Network.PlayAnimation(map, command.Data1, command.Data3, command.Data4, 0, 0);
                                                    break;
                                            }
                                        ...
                                        case (byte) EventCommand.OpenShop:
                                        {
                                            ...
                                            {
                                                Network.OpenShop(i, command.Data1);
                                        ...
                                        case (byte) EventCommand.ShowChatBubble:
                                        {
                                            ...
                                            switch (command.Data1)
                                            {
                                                case (byte) TargetType.Player:
                                                    Network.ChatBubble(map, i, command.Data1, command.Text1, (int) color);
                                                    break;
                                                case (byte) TargetType.Npc:
                                                    Network.ChatBubble(map, command.Data2, command.Data1, command.Text1, (int) color);
                                                    break;
                                        ...
                                        case (byte) EventCommand.FadeIn:
                                            Network.SpecialEffect(i, Event.EffectTypeFadeIn);
                                            break;

                                        case (byte) EventCommand.FadeOut:
                                            Network.SpecialEffect(i, Event.EffectTypeFadeOut);
                                            break;

                                        case (byte) EventCommand.FlashScreen:
                                            Network.SpecialEffect(i, Event.EffectTypeFlash);
                                            break;

                                        case (byte) EventCommand.SetFog:
                                            Network.SpecialEffect(i, Event.EffectTypeFog, command.Data1, command.Data2, command.Data3);
                                            break;

                                        case (byte) EventCommand.SetWeather:
                                            Network.SpecialEffect(i, Event.EffectTypeWeather, command.Data1, command.Data2);
                                            break;

                                        case (byte) EventCommand.SetScreenTint:
                                            Network.SpecialEffect(i, Event.EffectTypeTint, command.Data1, command.Data2, command.Data3, command.Data4);
                                            break;
